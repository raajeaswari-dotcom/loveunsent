...
const productSubItems = [
    ...
    { label: 'Perfumes', href: '/super-admin/products/perfumes' },
    { label: 'Handwriting', href: '/super-admin/products/handwriting' },
    { label: 'Occasions', href: '/super-admin/products/occasions' },
];
...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const [productsExpanded, setProductsExpanded] = useState(pathname.includes('/super-admin/products'));
    const [settingsExpanded, setSettingsExpanded] = useState(pathname.includes('/super-admin/settings'));
        ...
        <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-900">
            ...
            <aside className="w-64 bg-zinc-900 text-white hidden md:flex flex-col">
                <div className="p-6 border-b border-zinc-800 flex items-center gap-2">
                    ...
                    <h1 className="text-xl font-serif font-bold">Super<span className="text-purple-400">.Admin</span></h1>
                </div>
                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                    ...
                    <div className="pt-2">
                        <Button
                            ...
                            className={`w-full justify-start gap-3 hover:bg-zinc-800 hover:text-white ${pathname.includes('/super-admin/products') ? 'bg-zinc-800 text-white' : 'text-zinc-400'}`}
                        >
                    ...
                    <div className="pt-2">
                        <Button
                            ...
                            className={`w-full justify-start gap-3 hover:bg-zinc-800 hover:text-white ${pathname.includes('/super-admin/settings') ? 'bg-zinc-800 text-white' : 'text-zinc-400'}`}
                        >
